...
public class WeixinConfig {
    ...
    RefreshWeixinToken refreshWeixinOffiToken(WeiXinTokenRepository weiXinTokenRepository, WxBasicApi wxOffiBasicApi) {
        return new RefreshWeixinToken(weiXinTokenRepository, wxOffiBasicApi, "公众号");
    }

    @Bean
    RefreshWeixinToken refreshWeixinAppToken(WeiXinTokenRepository weiXinTokenRepository, WxBasicApi wxAppBasicApi) {
        return new RefreshWeixinToken(weiXinTokenRepository, wxAppBasicApi, "小程序");
    }
    ...
    @Bean
    WxMessageApi wxMessageApi(WxHttpClient client) {
        return new WxMessageApi(client);
    }
